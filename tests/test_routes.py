...
class TestAccountService(TestCase):
    ...
    def test_get_account_not_found_content(self):
        """It should return error message when account not found"""
        resp = self.client.get(f"{BASE_URL}/999999")
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)
        data = resp.get_json()
        self.assertIn("not be found", data["message"])

    def test_get_account_invalid_id(self):
        """It should return 404 when account id is invalid"""
    ...
    def test_update_account_not_found(self):
        ...
        resp = self.client.put(
            f"{BASE_URL}/0",
            json={"name": "Test", "address": "123 Test St"},
            content_type="application/json"
        )
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_delete_account_not_found(self):
        ...
        self.assertEqual(resp.status_code, status.HTTP_204_NO_CONTENT)  # DELETE returns 204 even if not found
    ...
    def test_method_not_allowed(self):
        ...
        resp = self.client.delete(BASE_URL)  # DELETE not allowed on collection
